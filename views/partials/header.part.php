...
<header class="navbar navbar-dark navbar-expand bg-dark" id="top">
    <a href="index.php">
        <div class="hvr-overline-from-right h1-cont">
            <h1 class="navbar-brand d-none d-sm-block hvr-underline-from-left">SMART LIVING</h1>
        </div>
    </a>
    ...
    <?php else: ?>
        <div class="dropdown ml-auto mr-3">
            ...
            <div class="dropdown-toggle d-none d-md-block" id="dropdownMenuId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: white">
                <div><img class="mr-3" src="<?= $usuario->getFoto() ?>"></div>
