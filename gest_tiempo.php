    ...
    if (!empty($data_parsed)): ?>
        <ul class="nav nav-tabs nav-fill mb-3" id="myTab" role="tablist">
            <?php for ($i = 1; $i <= 5; $i++): ?>
                <li class="nav-item">
                    <?php if ($i == 1) : ?>
                        <a class="nav-link active" id="dia<?= $i ?>_tab" data-toggle="tab" href="#dia<?= $i ?>"
                           role="tab" aria-controls="dia<?= $i ?>" aria-selected="true"><?= $fechas[$i - 1] ?></a>
                    <?php else : ?>
                        <a class="nav-link" id="dia<?= $i ?>_tab" data-toggle="tab" href="#dia<?= $i ?>" role="tab"
                           aria-controls="dia<?= $i ?>" aria-selected="false"><?= $fechas[$i - 1] ?></a>
                    <?php endif; ?>
                </li>
            <?php endfor; ?>
        </ul>
                ...
                <div class="carousel-item">
                    ...
                    <div class="temp_info" style="color: black">
                        ...
                        <div class="temp_info">
                            ...
                            Min: <?= $data_aux['list'][$k]['main']['temp_min'] ?>ºC -
                            Max: <?= $data_aux['list'][$k]['main']['temp_max'] ?>ºC<br>
