    ...
    let logFile = 'users/mgarcia@hotmail.com/registro.log';
    ...
    server.listen(11817);
    registrar(logFile, 'Servidor lanzado escuchando por el puerto 11817');
    ...
    function registrar(file, text) {
        ...
        console.log(Date() + ' --> ' + text);
            ...
            let RELAY1 = new Gpio(1, 'out');
            let relayStatus1 = 0;
            
            let RELAY2 = new Gpio(2, 'out');
            let relayStatus2 = 0;
            
            let RELAY3 = new Gpio(3, 'out');
            let relayStatus3 = 0;
            
            let RELAY4 = new Gpio(4, 'out');
            let relayStatus4 = 0;
